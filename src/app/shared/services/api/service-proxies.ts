...
export interface IClientApi {
     ...
     * @return OK
     */
    configCertificatesPut(body: ConfigCertificatesPutBody): Observable<ResponseBase>;
    /**
     ...
     * @return OK
     */
    configNetworkPost(body: ConfigNetworkPostBody): Observable<ConfigNetworkPostResponse>;
    /**
     ...
     * @return OK
     */
    configPermissionsPut(body: ConfigPermissionsPutBody): Observable<ResponseBase>;
    /**
     ...
     * @return OK
     */
    duplicateobjectsGet(type?: string | undefined, name?: string | undefined): Observable<DuplicateObjectsGetResponse>;
    /**
     ...
     * @return OK
     */
    emailnotificationsPost(body: EmailnotificationsPostBody): Observable<ResponseBase>;
    /**
     * Retrieve a list email notification names, or a single configuration
     * @param name (optional)
     * @return OK
     */
    emailnotificationsGet(name?: string | undefined): Observable<EmailnotificationsGetResponse>;
    /**
     * Update specified email notification
     * @return OK
     */
    emailnotificationsPut(body: EmailnotificationsPutBody): Observable<ResponseBase>;
    /**
     ...
     * @return OK
     */
    securitymodesFipsPut(body: SecuritymodesFipsPutBody): Observable<ResponseBase>;
    /**
     ...
     * @return OK
     */
    systemDatabaseBackupPost(body: SystemDatabaseBackupPostBody): Observable<ResponseBase>;
    /**
     * Restore a specified database backup
     * @return OK
     */
    systemDatabaseBackupPut(body: SystemDatabaseBackupPutBody): Observable<ResponseBase>;
    /**
     ...
     * @return OK
     */
    templatesGet(name?: string | undefined, type?: Type | undefined): Observable<TemplatesGetResponse>;
    /**
     * Update template
     * @return OK
     */
     ...
     * @return OK
     */
    usersGet(username?: string | undefined, usergroup?: string | undefined, page?: number | undefined, pageCount?: number | undefined): Observable<UsersGetResponse>;
    /**
...
export class ClientApi implements IClientApi {
    ...
    constructor(@Inject(HttpClient) http: HttpClient, @Optional() @Inject(API_BASE_URL) baseUrl?: string) {
        this.http = http;
        this.baseUrl = baseUrl ? baseUrl : "https://virtserver.swaggerhub.com/j2m/KMES-Service-Proxy/1.0.0";
    }
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<ConfigAutoBackupGetResponse>><any>_observableThrow(e);
                }
            } else
                return <Observable<ConfigAutoBackupGetResponse>><any>_observableThrow(response_);
        }));
    }

    protected processConfigAutobackupGet(response: HttpResponseBase): Observable<ConfigAutoBackupGetResponse> {
        ...
        if (status === 200) {
            ...
            return throwException("Internal Server Error", status, _responseText, _headers, resultdefault);
            }));
        }
    }
    ...
    protected processConfigAutobackupPut(response: HttpResponseBase): Observable<ResponseBase> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<ConfigCertificatesGetResponse>><any>_observableThrow(e);
                }
            } else
                return <Observable<ConfigCertificatesGetResponse>><any>_observableThrow(response_);
        }));
    }

    protected processConfigCertificatesGet(response: HttpResponseBase): Observable<ConfigCertificatesGetResponse> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
    ...
    protected processConfigCertificatesPut(response: HttpResponseBase): Observable<ResponseBase> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<ConfigFtpGetResponse>><any>_observableThrow(e);
                }
            } else
                return <Observable<ConfigFtpGetResponse>><any>_observableThrow(response_);
        }));
    }

    protected processConfigFtpGet(response: HttpResponseBase): Observable<ConfigFtpGetResponse> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
    ...
    protected processConfigFtpPut(response: HttpResponseBase): Observable<ResponseBase> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
    ...
    protected processConfigFtpPost(response: HttpResponseBase): Observable<ResponseBase> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<ConfigKmipGetResponse>><any>_observableThrow(e);
                }
            } else
                return <Observable<ConfigKmipGetResponse>><any>_observableThrow(response_);
        }));
    }

    protected processConfigKmipGet(response: HttpResponseBase): Observable<ConfigKmipGetResponse> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
    ...
    protected processConfigKmipPut(response: HttpResponseBase): Observable<ResponseBase> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<ConfigLdapGetResponse>><any>_observableThrow(e);
                }
            } else
                return <Observable<ConfigLdapGetResponse>><any>_observableThrow(response_);
        }));
    }

    protected processConfigLdapGet(response: HttpResponseBase): Observable<ConfigLdapGetResponse> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
    ...
    protected processConfigLdapPut(response: HttpResponseBase): Observable<ResponseBase> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
    ...
    protected processConfigLdapPost(response: HttpResponseBase): Observable<ResponseBase> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<ConfigNetworkGetResponse>><any>_observableThrow(e);
                }
            } else
                return <Observable<ConfigNetworkGetResponse>><any>_observableThrow(response_);
        }));
    }

    protected processConfigNetworkGet(response: HttpResponseBase): Observable<ConfigNetworkGetResponse> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
    ...
    protected processConfigNetworkPut(response: HttpResponseBase): Observable<ResponseBase> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<ConfigNetworkPostResponse>><any>_observableThrow(e);
                }
            } else
                return <Observable<ConfigNetworkPostResponse>><any>_observableThrow(response_);
        }));
    }

    protected processConfigNetworkPost(response: HttpResponseBase): Observable<ConfigNetworkPostResponse> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<ConfigNtpGetResponse>><any>_observableThrow(e);
                }
            } else
                return <Observable<ConfigNtpGetResponse>><any>_observableThrow(response_);
        }));
    }

    protected processConfigNtpGet(response: HttpResponseBase): Observable<ConfigNtpGetResponse> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
    ...
    protected processConfigNtpPut(response: HttpResponseBase): Observable<ResponseBase> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<ConfigOcspGetResponse>><any>_observableThrow(e);
                }
            } else
                return <Observable<ConfigOcspGetResponse>><any>_observableThrow(response_);
        }));
    }

    protected processConfigOcspGet(response: HttpResponseBase): Observable<ConfigOcspGetResponse> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
    ...
    protected processConfigOcspPut(response: HttpResponseBase): Observable<ResponseBase> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<ConfigPasswordsGetResponse>><any>_observableThrow(e);
                }
            } else
                return <Observable<ConfigPasswordsGetResponse>><any>_observableThrow(response_);
        }));
    }

    protected processConfigPasswordsGet(response: HttpResponseBase): Observable<ConfigPasswordsGetResponse> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
    ...
    protected processConfigPasswordsPut(response: HttpResponseBase): Observable<ResponseBase> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<ConfigPermissionsGetResponse>><any>_observableThrow(e);
                }
            } else
                return <Observable<ConfigPermissionsGetResponse>><any>_observableThrow(response_);
        }));
    }

    protected processConfigPermissionsGet(response: HttpResponseBase): Observable<ConfigPermissionsGetResponse> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
    ...
    protected processConfigPermissionsPut(response: HttpResponseBase): Observable<ResponseBase> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<ConfigRegauthGetResponse>><any>_observableThrow(e);
                }
            } else
                return <Observable<ConfigRegauthGetResponse>><any>_observableThrow(response_);
        }));
    }

    protected processConfigRegauthGet(response: HttpResponseBase): Observable<ConfigRegauthGetResponse> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
    ...
    protected processConfigRegauthPut(response: HttpResponseBase): Observable<ResponseBase> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
    ...
    protected processConfigSecurityGet(response: HttpResponseBase): Observable<any> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
    ...
    protected processConfigSecurityPut(response: HttpResponseBase): Observable<ResponseBase> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<ConfigSmtpGetResponse>><any>_observableThrow(e);
                }
            } else
                return <Observable<ConfigSmtpGetResponse>><any>_observableThrow(response_);
        }));
    }

    protected processConfigSmtpGet(response: HttpResponseBase): Observable<ConfigSmtpGetResponse> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
    ...
    protected processConfigSmtpPut(response: HttpResponseBase): Observable<ResponseBase> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
    ...
    protected processConfigSmtpPost(response: HttpResponseBase): Observable<ResponseBase> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<DuplicateObjectsGetResponse>><any>_observableThrow(e);
                }
            } else
                return <Observable<DuplicateObjectsGetResponse>><any>_observableThrow(response_);
        }));
    }

    protected processDuplicateobjectsGet(response: HttpResponseBase): Observable<DuplicateObjectsGetResponse> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
    ...
    protected processDuplicateobjectsDelete(response: HttpResponseBase): Observable<ResponseBase> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
    ...
    protected processEmailnotificationsPost(response: HttpResponseBase): Observable<ResponseBase> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<EmailnotificationsGetResponse>><any>_observableThrow(e);
                }
            } else
                return <Observable<EmailnotificationsGetResponse>><any>_observableThrow(response_);
        }));
    }

    protected processEmailnotificationsGet(response: HttpResponseBase): Observable<EmailnotificationsGetResponse> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
    ...
    protected processEmailnotificationsPut(response: HttpResponseBase): Observable<ResponseBase> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
    ...
    protected processEmailnotificationsDelete(response: HttpResponseBase): Observable<ResponseBase> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
    ...
    features(): Observable<FeaturesResponse> {
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                ...
                return <Observable<FeaturesResponse>><any>_observableThrow(response_);
        }));
    }

    protected processFeatures(response: HttpResponseBase): Observable<FeaturesResponse> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<FeaturesRequestGetResponse>><any>_observableThrow(e);
                }
            } else
                return <Observable<FeaturesRequestGetResponse>><any>_observableThrow(response_);
        }));
    }

    protected processFeaturesRequestGet(response: HttpResponseBase): Observable<FeaturesRequestGetResponse> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        return this.http.request("put", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<FeaturesRequestPutResponse>><any>_observableThrow(e);
                }
            } else
                return <Observable<FeaturesRequestPutResponse>><any>_observableThrow(response_);
        }));
    }

    protected processFeaturesRequestPut(response: HttpResponseBase): Observable<FeaturesRequestPutResponse> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<FunctionsGetResponse>><any>_observableThrow(e);
                }
            } else
                return <Observable<FunctionsGetResponse>><any>_observableThrow(response_);
        }));
    }

    protected processFunctionsGet(response: HttpResponseBase): Observable<FunctionsGetResponse> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
    ...
    protected processFunctionsPut(response: HttpResponseBase): Observable<ResponseBase> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
    ...
    protected processFxcertcrlsPost(response: HttpResponseBase): Observable<ResponseBase> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<FxcertcrlsGetResponse>><any>_observableThrow(e);
                }
            } else
                return <Observable<FxcertcrlsGetResponse>><any>_observableThrow(response_);
        }));
    }

    protected processFxcertcrlsGet(response: HttpResponseBase): Observable<FxcertcrlsGetResponse> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
    ...
    fxcertcrlsDelete(certType: CertType): Observable<ResponseBase> {
        ...
        if (certType === undefined || certType === null)
            throw new Error("The parameter 'certType' must be defined and cannot be null.");
        else
            url_ += "certType=" + encodeURIComponent("" + certType) + "&";
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processFxcertcrlsDelete(response: HttpResponseBase): Observable<ResponseBase> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<LogsMiscGetResponse>><any>_observableThrow(e);
                }
            } else
                return <Observable<LogsMiscGetResponse>><any>_observableThrow(response_);
        }));
    }

    protected processLogsMiscGet(response: HttpResponseBase): Observable<LogsMiscGetResponse> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
    ...
    protected processLogsMiscPut(response: HttpResponseBase): Observable<ResponseBase> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<LogsPruneGetResponse>><any>_observableThrow(e);
                }
            } else
                return <Observable<LogsPruneGetResponse>><any>_observableThrow(response_);
        }));
    }

    protected processLogsPruneGet(response: HttpResponseBase): Observable<LogsPruneGetResponse> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
    ...
    protected processLogsPrunePut(response: HttpResponseBase): Observable<ResponseBase> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<LogsSyslogGetResponse>><any>_observableThrow(e);
                }
            } else
                return <Observable<LogsSyslogGetResponse>><any>_observableThrow(response_);
        }));
    }

    protected processLogsSyslogGet(response: HttpResponseBase): Observable<LogsSyslogGetResponse> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
    ...
    protected processLogsSyslogPut(response: HttpResponseBase): Observable<ResponseBase> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<LogsAuditGetResponse>><any>_observableThrow(e);
                }
            } else
                return <Observable<LogsAuditGetResponse>><any>_observableThrow(response_);
        }));
    }

    protected processLogsAuditGet(response: HttpResponseBase): Observable<LogsAuditGetResponse> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
    ...
    protected processLogsAuditPut(response: HttpResponseBase): Observable<ResponseBase> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
    ...
    protected processPrintersPost(response: HttpResponseBase): Observable<ResponseBase> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<PrintersGetResponse>><any>_observableThrow(e);
                }
            } else
                return <Observable<PrintersGetResponse>><any>_observableThrow(response_);
        }));
    }

    protected processPrintersGet(response: HttpResponseBase): Observable<PrintersGetResponse> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
    ...
    protected processPrintersPut(response: HttpResponseBase): Observable<ResponseBase> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
    ...
    protected processPrintersDelete(response: HttpResponseBase): Observable<ResponseBase> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<SecuritymodesFipsGetResponse>><any>_observableThrow(e);
                }
            } else
                return <Observable<SecuritymodesFipsGetResponse>><any>_observableThrow(response_);
        }));
    }

    protected processSecuritymodesFipsGet(response: HttpResponseBase): Observable<SecuritymodesFipsGetResponse> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
    ...
    protected processSecuritymodesFipsPut(response: HttpResponseBase): Observable<ResponseBase> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<SecuritymodesPciGetResponse>><any>_observableThrow(e);
                }
            } else
                return <Observable<SecuritymodesPciGetResponse>><any>_observableThrow(response_);
        }));
    }

    protected processSecuritymodesPciGet(response: HttpResponseBase): Observable<SecuritymodesPciGetResponse> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
    ...
    protected processSecuritymodesPciPut(response: HttpResponseBase): Observable<ResponseBase> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
    ...
    protected processSftpeventsPost(response: HttpResponseBase): Observable<ResponseBase> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<SftpEventsGetResponse>><any>_observableThrow(e);
                }
            } else
                return <Observable<SftpEventsGetResponse>><any>_observableThrow(response_);
        }));
    }

    protected processSftpeventsGet(response: HttpResponseBase): Observable<SftpEventsGetResponse> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
    ...
    protected processSftpeventsPut(response: HttpResponseBase): Observable<ResponseBase> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
    ...
    protected processSftpeventsDelete(response: HttpResponseBase): Observable<ResponseBase> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
    ...
    systemGet(): Observable<SystemGetResponse> {
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                ...
                return <Observable<SystemGetResponse>><any>_observableThrow(response_);
        }));
    }

    protected processSystemGet(response: HttpResponseBase): Observable<SystemGetResponse> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
    ...
    protected processSystemPut(response: HttpResponseBase): Observable<ResponseBase> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<SystemDatetimeGetResponse>><any>_observableThrow(e);
                }
            } else
                return <Observable<SystemDatetimeGetResponse>><any>_observableThrow(response_);
        }));
    }

    protected processSystemDatetimeGet(response: HttpResponseBase): Observable<SystemDatetimeGetResponse> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
    ...
    protected processSystemDatetimePut(response: HttpResponseBase): Observable<ResponseBase> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<SystemFirmwareGetResponse>><any>_observableThrow(e);
                }
            } else
                return <Observable<SystemFirmwareGetResponse>><any>_observableThrow(response_);
        }));
    }

    protected processSystemFirmwareGet(response: HttpResponseBase): Observable<SystemFirmwareGetResponse> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
    ...
    protected processSystemFirmwarePut(response: HttpResponseBase): Observable<ResponseBase> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<SystemDatabaseGetResponse>><any>_observableThrow(e);
                }
            } else
                return <Observable<SystemDatabaseGetResponse>><any>_observableThrow(response_);
        }));
    }

    protected processSystemDatabaseGet(response: HttpResponseBase): Observable<SystemDatabaseGetResponse> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
    ...
    protected processSystemDatabasePost(response: HttpResponseBase): Observable<ResponseBase> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<SystemDatabaseBackupGetResponse>><any>_observableThrow(e);
                }
            } else
                return <Observable<SystemDatabaseBackupGetResponse>><any>_observableThrow(response_);
        }));
    }

    protected processSystemDatabaseBackupGet(response: HttpResponseBase): Observable<SystemDatabaseBackupGetResponse> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
    ...
    protected processSystemDatabaseBackupPost(response: HttpResponseBase): Observable<ResponseBase> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
    ...
    protected processSystemDatabaseBackupPut(response: HttpResponseBase): Observable<ResponseBase> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<SystemDiskGetResponse>><any>_observableThrow(e);
                }
            } else
                return <Observable<SystemDiskGetResponse>><any>_observableThrow(response_);
        }));
    }

    protected processSystemDiskGet(response: HttpResponseBase): Observable<SystemDiskGetResponse> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
    ...
    protected processSystemDiskPut(response: HttpResponseBase): Observable<ResponseBase> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
    ...
    systemRaid(path?: string | undefined): Observable<SystemRaidResponse> {
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                ...
                return <Observable<SystemRaidResponse>><any>_observableThrow(response_);
        }));
    }

    protected processSystemRaid(response: HttpResponseBase): Observable<SystemRaidResponse> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
    ...
    protected processTemplatesPost(response: HttpResponseBase): Observable<ResponseBase> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<TemplatesGetResponse>><any>_observableThrow(e);
                }
            } else
                return <Observable<TemplatesGetResponse>><any>_observableThrow(response_);
        }));
    }

    protected processTemplatesGet(response: HttpResponseBase): Observable<TemplatesGetResponse> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
    ...
    protected processTemplatesPut(response: HttpResponseBase): Observable<ResponseBase> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
    ...
    protected processTemplatesDelete(response: HttpResponseBase): Observable<ResponseBase> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
    ...
    protected processUsergroupsPost(response: HttpResponseBase): Observable<ResponseBase> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<UsergroupsGetResponse>><any>_observableThrow(e);
                }
            } else
                return <Observable<UsergroupsGetResponse>><any>_observableThrow(response_);
        }));
    }

    protected processUsergroupsGet(response: HttpResponseBase): Observable<UsergroupsGetResponse> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
    ...
    protected processUsergroupsPut(response: HttpResponseBase): Observable<ResponseBase> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
    ...
    protected processUsergroupsDelete(response: HttpResponseBase): Observable<ResponseBase> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
    ...
    protected processUsersPost(response: HttpResponseBase): Observable<ResponseBase> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
    ...
    usersGet(username?: string | undefined, usergroup?: string | undefined, page?: number | undefined, pageCount?: number | undefined): Observable<UsersGetResponse> {
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                ...
                return <Observable<UsersGetResponse>><any>_observableThrow(response_);
        }));
    }

    protected processUsersGet(response: HttpResponseBase): Observable<UsersGetResponse> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
    ...
    protected processUsersPut(response: HttpResponseBase): Observable<ResponseBase> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
    ...
    protected processUsersDelete(response: HttpResponseBase): Observable<ResponseBase> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
    ...
    protected processWebserverPost(response: HttpResponseBase): Observable<ResponseBase> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<WebserverGetResponse>><any>_observableThrow(e);
                }
            } else
                return <Observable<WebserverGetResponse>><any>_observableThrow(response_);
        }));
    }

    protected processWebserverGet(response: HttpResponseBase): Observable<WebserverGetResponse> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
    ...
    protected processWebserverPut(response: HttpResponseBase): Observable<ResponseBase> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
...
export class SharedExportValues implements ISharedExportValues {
    ...
    init(data?: any) {
        if (data) {
            ...
            if (Array.isArray(data["runOn"])) {
                this.runOn = [] as any;
                for (let item of data["runOn"])
                    this.runOn!.push(item);
            }
    ...
    toJSON(data?: any) {
        ...
        if (Array.isArray(this.runOn)) {
            data["runOn"] = [];
            for (let item of this.runOn)
                data["runOn"].push(item);
        }
...
export class LogExportEvents extends SharedExportValues implements ILogExportEvents {
    startDate!: string;
    endDate!: string;
...
export class KeyExportEvents extends SharedExportValues implements IKeyExportEvents {
...
export class KMIPSettings implements IKMIPSettings {
    ...
    constructor(data?: IKMIPSettings) {
        if (data) {
            ...
            this.timestampFilter = data.timestampFilter && !(<any>data.timestampFilter).toJSON ? new TimestampFilter(data.timestampFilter) : <TimestampFilter>this.timestampFilter;
            this.arrivalFilter = data.arrivalFilter && !(<any>data.arrivalFilter).toJSON ? new ArrivalFilter(data.arrivalFilter) : <ArrivalFilter>this.arrivalFilter;
        }
    }
    ...
    init(data?: any) {
        if (data) {
            ...
            this.timestampFilter = data["timestampFilter"] ? TimestampFilter.fromJS(data["timestampFilter"]) : <any>undefined;
            this.arrivalFilter = data["arrivalFilter"] ? ArrivalFilter.fromJS(data["arrivalFilter"]) : <any>undefined;
        }
    }
    ...
    toJSON(data?: any) {
        ...
        data["timestampFilter"] = this.timestampFilter ? this.timestampFilter.toJSON() : <any>undefined;
        data["arrivalFilter"] = this.arrivalFilter ? this.arrivalFilter.toJSON() : <any>undefined;
        return data;
    }
}
...
export class LDAPConfig implements ILDAPConfig {
    ...
    constructor(data?: ILDAPConfig) {
        if (data) {
            ...
            this.groupPerms = data.groupPerms && !(<any>data.groupPerms).toJSON ? new GroupPerms(data.groupPerms) : <GroupPerms>this.groupPerms;
        }
    }
    ...
    init(data?: any) {
        if (data) {
            ...
            this.groupPerms = data["groupPerms"] ? GroupPerms.fromJS(data["groupPerms"]) : <any>undefined;
    ...
    toJSON(data?: any) {
        ...
        if (Array.isArray(this.failoverServers)) {
            ...
            for (let item of this.failoverServers)
                data["failoverServers"].push(item);
        }
        ...
        data["groupPerms"] = this.groupPerms ? this.groupPerms.toJSON() : <any>undefined;
        ...
        if (data) {
            ...
            if (data.permissions) {
                ...
                for (let i = 0; i < data.permissions.length; i++) {
                    ...
                    this.permissions[i] = item && !(<any>item).toJSON ? new Permissions2(item) : <Permissions2>item;
                }
            }
        }
    }
    ...
    constructor(data?: ISetPermissions) {
        if (data) {
            ...
            if (data.permissions) {
                ...
                for (let i = 0; i < data.permissions.length; i++) {
                    let item = data.permissions[i];
                    this.permissions[i] = item && !(<any>item).toJSON ? new Permissions3(item) : <Permissions3>item;
                }
            }
        }
        if (!data) {
    ...
    init(data?: any) {
        if (data) {
            if (Array.isArray(data["objectTypes"])) {
                ...
                for (let item of data["objectTypes"])
...
export class ListObjectNames implements IListObjectNames {
    ...
    init(data?: any) {
        if (data) {
            if (Array.isArray(data["objectNames"])) {
                ...
                for (let item of data["objectNames"])
    ...
    toJSON(data?: any) {
        ...
        if (Array.isArray(this.objectNames)) {
            data["objectNames"] = [];
            for (let item of this.objectNames)
                data["objectNames"].push(item);
        }
        return data;
    }
}
        ...
        if (data) {
            ...
            if (data.duplicates) {
                ...
                for (let i = 0; i < data.duplicates.length; i++) {
                    ...
                    this.duplicates[i] = item && !(<any>item).toJSON ? new DuplicateObject(item) : <DuplicateObject>item;
                }
            }
        }
    }
    ...
    toJSON(data?: any) {
        ...
        if (Array.isArray(this.duplicates)) {
            ...
            for (let item of this.duplicates)
                data["duplicates"].push(item.toJSON());
        }
        return data;
    }
}
...
export class SmtpEvent implements ISmtpEvent {
    ...
    constructor(data?: ISmtpEvent) {
        if (data) {
            ...
            this.events = data.events && !(<any>data.events).toJSON ? new Events(data.events) : <Events>this.events;
        }
    }
...
export class FeatureList implements IFeatureList {
    ...
    constructor(data?: IFeatureList) {
        if (data) {
            ...
            this.features = data.features && !(<any>data.features).toJSON ? new Features(data.features) : <Features>this.features;
        }
    }
        ...
        if (data) {
            ...
            if (data.functions) {
                ...
                for (let i = 0; i < data.functions.length; i++) {
                    ...
                    this.functions[i] = item && !(<any>item).toJSON ? new FunctionObject(item) : <FunctionObject>item;
                }
            }
        }
    }
...
export class LoginRequest implements ILoginRequest {
    ...
    constructor(data?: ILoginRequest) {
        if (data) {
            ...
            this.authCredentials = data.authCredentials && !(<any>data.authCredentials).toJSON ? new AuthCredentials(data.authCredentials) : <AuthCredentials>this.authCredentials;
        }
    }
    ...
    init(data?: any) {
        if (data) {
            this.authType = data["authType"];
            this.authCredentials = data["authCredentials"] ? AuthCredentials.fromJS(data["authCredentials"]) : <any>undefined;
        }
    }
    ...
    toJSON(data?: any) {
        data = typeof data === 'object' ? data : {};
        data["authType"] = this.authType;
        data["authCredentials"] = this.authCredentials ? this.authCredentials.toJSON() : <any>undefined;
        return data;
    }
}
...
export class LoginUsers implements ILoginUsers {
    ...
    init(data?: any) {
        if (data) {
            if (Array.isArray(data["loggedInUsers"])) {
                ...
                for (let item of data["loggedInUsers"])
                    this.loggedInUsers!.push(item);
            }
        }
    }
    ...
    toJSON(data?: any) {
        ...
        if (Array.isArray(this.loggedInUsers)) {
            data["loggedInUsers"] = [];
            for (let item of this.loggedInUsers)
                data["loggedInUsers"].push(item);
        }
        return data;
    }
}
...
export class LogFileList implements ILogFileList {
    ...
    init(data?: any) {
        if (data) {
            if (Array.isArray(data["serverLogs"])) {
                ...
                for (let item of data["serverLogs"])
                    this.serverLogs!.push(item);
            }
            if (Array.isArray(data["clientLogs"])) {
                this.clientLogs = [] as any;
                for (let item of data["clientLogs"])
                    this.clientLogs!.push(item);
            }
            if (Array.isArray(data["cardLogs"])) {
                this.cardLogs = [] as any;
                for (let item of data["cardLogs"])
                    this.cardLogs!.push(item);
            }
            if (Array.isArray(data["webLogs"])) {
                this.webLogs = [] as any;
                for (let item of data["webLogs"])
                    this.webLogs!.push(item);
            }
    ...
    toJSON(data?: any) {
        ...
        if (Array.isArray(this.serverLogs)) {
            data["serverLogs"] = [];
            for (let item of this.serverLogs)
                data["serverLogs"].push(item);
        }
        if (Array.isArray(this.clientLogs)) {
            data["clientLogs"] = [];
            for (let item of this.clientLogs)
                data["clientLogs"].push(item);
        }
        if (Array.isArray(this.cardLogs)) {
            data["cardLogs"] = [];
            for (let item of this.cardLogs)
                data["cardLogs"].push(item);
        }
        if (Array.isArray(this.webLogs)) {
            data["webLogs"] = [];
            for (let item of this.webLogs)
                data["webLogs"].push(item);
        }
        ...
        if (data) {
            ...
            if (data.serverAddresses) {
                ...
                for (let i = 0; i < data.serverAddresses.length; i++) {
                    ...
                    this.serverAddresses[i] = item && !(<any>item).toJSON ? new ServerAddresses(item) : <ServerAddresses>item;
                }
            }
        }
    }
...
export class PrinterList implements IPrinterList {
    ...
    init(data?: any) {
        if (data) {
            if (Array.isArray(data["installed"])) {
                ...
                for (let item of data["installed"])
    ...
    toJSON(data?: any) {
        ...
        if (Array.isArray(this.installed)) {
            data["installed"] = [];
            for (let item of this.installed)
                data["installed"].push(item);
        }
...
export class SftpEvent implements ISftpEvent {
    ...
    constructor(data?: ISftpEvent) {
        if (data) {
            ...
            this.events = data.events && !(<any>data.events).toJSON ? new Events2(data.events) : <Events2>this.events;
        }
        if (!data) {
    ...
    init(data?: any) {
        if (data) {
            this.name = data["name"];
            this.enabled = data["enabled"];
            this.events = data["events"] ? Events2.fromJS(data["events"]) : new Events2();
        }
    }
...
export class SystemDateTime implements ISystemDateTime {
    ...
    init(data?: any) {
        if (data) {
            this.utcDateTime = data["utcDateTime"] ? new Date(data["utcDateTime"].toString()) : <any>undefined;
    ...
    toJSON(data?: any) {
        data = typeof data === 'object' ? data : {};
        data["utcDateTime"] = this.utcDateTime ? this.utcDateTime.toISOString() : <any>undefined;
...
export class DBInfo implements IDBInfo {
    ...
    init(data?: any) {
        if (data) {
            ...
            this.lastRestore = data["lastRestore"] ? new Date(data["lastRestore"].toString()) : <any>undefined;
            this.lastBackup = data["lastBackup"] ? new Date(data["lastBackup"].toString()) : <any>undefined;
        }
    }
    ...
    toJSON(data?: any) {
        ...
        data["lastRestore"] = this.lastRestore ? this.lastRestore.toISOString() : <any>undefined;
        data["lastBackup"] = this.lastBackup ? this.lastBackup.toISOString() : <any>undefined;
        return data;
    }
}
...
export class RaidList implements IRaidList {
    ...
    init(data?: any) {
        if (data) {
            if (Array.isArray(data["raidPaths"])) {
                ...
                for (let item of data["raidPaths"])
                    this.raidPaths!.push(item);
            }
        }
    }
    ...
    toJSON(data?: any) {
        ...
        if (Array.isArray(this.raidPaths)) {
            data["raidPaths"] = [];
            for (let item of this.raidPaths)
                data["raidPaths"].push(item);
        }
        return data;
    }
}
...
export class UserGroup implements IUserGroup {
    ...
    constructor(data?: IUserGroup) {
        if (data) {
            ...
            this.permissions = data.permissions && !(<any>data.permissions).toJSON ? new Permissions(data.permissions) : <Permissions>this.permissions;
            this.passPolicy = data.passPolicy && !(<any>data.passPolicy).toJSON ? new PasswordPolicy(data.passPolicy) : <PasswordPolicy>this.passPolicy;
            this.oauthSettings = data.oauthSettings && !(<any>data.oauthSettings).toJSON ? new OAuthSettings(data.oauthSettings) : <OAuthSettings>this.oauthSettings;
            this.otpSettings = data.otpSettings && !(<any>data.otpSettings).toJSON ? new OTPSettings(data.otpSettings) : <OTPSettings>this.otpSettings;
        }
        if (!data) {
    ...
    init(data?: any) {
        if (data) {
            ...
            this.permissions = data["permissions"] ? Permissions.fromJS(data["permissions"]) : <any>undefined;
            this.passPolicy = data["passPolicy"] ? PasswordPolicy.fromJS(data["passPolicy"]) : <any>undefined;
            this.loginsRequired = data["loginsRequired"];
            this.userLocation = data["userLocation"];
            this.ldapVerify = data["ldapVerify"] !== undefined ? data["ldapVerify"] : false;
            this.ldapGroup = data["ldapGroup"];
            this.oauthSettings = data["oauthSettings"] ? OAuthSettings.fromJS(data["oauthSettings"]) : <any>undefined;
            this.otpSettings = data["otpSettings"] ? OTPSettings.fromJS(data["otpSettings"]) : <any>undefined;
        }
    }
    ...
    toJSON(data?: any) {
        ...
        data["passPolicy"] = this.passPolicy ? this.passPolicy.toJSON() : <any>undefined;
        ...
        data["oauthSettings"] = this.oauthSettings ? this.oauthSettings.toJSON() : <any>undefined;
        data["otpSettings"] = this.otpSettings ? this.otpSettings.toJSON() : <any>undefined;
        return data;
    }
}
...
export class MoveGroup extends RequestBase implements IMoveGroup {
    ...
    constructor(data?: IMoveGroup) {
        super(data);
        if (data) {
            this.requestData = data.requestData && !(<any>data.requestData).toJSON ? new RequestData(data.requestData) : <RequestData>this.requestData;
        }
        if (!data) {
    ...
    init(data?: any) {
        super.init(data);
        if (data) {
            this.requestData = data["requestData"] ? RequestData.fromJS(data["requestData"]) : new RequestData();
        }
    }
    ...
    toJSON(data?: any) {
        data = typeof data === 'object' ? data : {};
        data["requestData"] = this.requestData ? this.requestData.toJSON() : <any>undefined;
        super.toJSON(data);
        return data;
    }
}
...
export class UpdateGroup extends RequestBase implements IUpdateGroup {
    ...
    constructor(data?: IUpdateGroup) {
        super(data);
        if (data) {
            this.requestData = data.requestData && !(<any>data.requestData).toJSON ? new RequestData2(data.requestData) : <RequestData2>this.requestData;
        }
        if (!data) {
    ...
    init(data?: any) {
        super.init(data);
        if (data) {
            this.requestData = data["requestData"] ? RequestData2.fromJS(data["requestData"]) : new RequestData2();
        }
    }
...
export class PasswordPolicy implements IPasswordPolicy {
    ...
    constructor(data?: IPasswordPolicy) {
        if (data) {
            ...
            this.length = data.length && !(<any>data.length).toJSON ? new MinMax(data.length) : <MinMax>this.length;
            this.alphabetical = data.alphabetical && !(<any>data.alphabetical).toJSON ? new MinMax(data.alphabetical) : <MinMax>this.alphabetical;
            this.uppercase = data.uppercase && !(<any>data.uppercase).toJSON ? new MinMax(data.uppercase) : <MinMax>this.uppercase;
            this.lowercase = data.lowercase && !(<any>data.lowercase).toJSON ? new MinMax(data.lowercase) : <MinMax>this.lowercase;
            this.numeric = data.numeric && !(<any>data.numeric).toJSON ? new MinMax(data.numeric) : <MinMax>this.numeric;
            this.symbols = data.symbols && !(<any>data.symbols).toJSON ? new MinMax(data.symbols) : <MinMax>this.symbols;
        }
    }

    init(data?: any) {
        if (data) {
            this.length = data["length"] ? MinMax.fromJS(data["length"]) : <any>undefined;
            this.alphabetical = data["alphabetical"] ? MinMax.fromJS(data["alphabetical"]) : <any>undefined;
            this.uppercase = data["uppercase"] ? MinMax.fromJS(data["uppercase"]) : <any>undefined;
            this.lowercase = data["lowercase"] ? MinMax.fromJS(data["lowercase"]) : <any>undefined;
            this.numeric = data["numeric"] ? MinMax.fromJS(data["numeric"]) : <any>undefined;
            this.symbols = data["symbols"] ? MinMax.fromJS(data["symbols"]) : <any>undefined;
        }
    }
    ...
    toJSON(data?: any) {
        ...
        data["alphabetical"] = this.alphabetical ? this.alphabetical.toJSON() : <any>undefined;
        data["uppercase"] = this.uppercase ? this.uppercase.toJSON() : <any>undefined;
        data["lowercase"] = this.lowercase ? this.lowercase.toJSON() : <any>undefined;
...
export class UserPersonalInfo implements IUserPersonalInfo {
    ...
    constructor(data?: IUserPersonalInfo) {
        if (data) {
            ...
            this.personalInfo = data.personalInfo && !(<any>data.personalInfo).toJSON ? new PersonalInfo(data.personalInfo) : <PersonalInfo>this.personalInfo;
        }
    }

    init(data?: any) {
        if (data) {
            this.personalInfo = data["personalInfo"] ? PersonalInfo.fromJS(data["personalInfo"]) : <any>undefined;
        }
    }
...
export class UpdateUser extends RequestBase implements IUpdateUser {
    ...
    constructor(data?: IUpdateUser) {
        super(data);
        if (data) {
            this.requestData = data.requestData && !(<any>data.requestData).toJSON ? new RequestData3(data.requestData) : <RequestData3>this.requestData;
        }
    }
...
export class MoveUser extends RequestBase implements IMoveUser {
    ...
    constructor(data?: IMoveUser) {
        super(data);
        if (data) {
            this.requestData = data.requestData && !(<any>data.requestData).toJSON ? new RequestData4(data.requestData) : <RequestData4>this.requestData;
        }
        if (!data) {
    ...
    init(data?: any) {
        super.init(data);
        if (data) {
            this.requestData = data["requestData"] ? RequestData4.fromJS(data["requestData"]) : new RequestData4();
        }
    }
...
export class ChangePassword extends RequestBase implements IChangePassword {
    ...
    constructor(data?: IChangePassword) {
        super(data);
        if (data) {
            this.requestData = data.requestData && !(<any>data.requestData).toJSON ? new RequestData5(data.requestData) : <RequestData5>this.requestData;
        }
        if (!data) {
    ...
    init(data?: any) {
        super.init(data);
        if (data) {
            this.requestData = data["requestData"] ? RequestData5.fromJS(data["requestData"]) : new RequestData5();
        }
    }
...
export class ConfigAutobackupPutBody extends RequestBase implements IBody {
    requestData!: AutoBackup;

    constructor(data?: IBody) {
        super(data);
        if (data) {
            this.requestData = data.requestData && !(<any>data.requestData).toJSON ? new AutoBackup(data.requestData) : <AutoBackup>this.requestData;
        }
        if (!data) {
    ...
    init(data?: any) {
        super.init(data);
        if (data) {
            this.requestData = data["requestData"] ? AutoBackup.fromJS(data["requestData"]) : new AutoBackup();
        }
    }
...
export interface IBody extends IRequestBase {
    requestData: IAutoBackup;
}

export class ConfigCertificatesPutBody extends RequestBase implements IBody2 {
    requestData!: CertSettings;

    constructor(data?: IBody2) {
        super(data);
        if (data) {
            this.requestData = data.requestData && !(<any>data.requestData).toJSON ? new CertSettings(data.requestData) : <CertSettings>this.requestData;
        }
        if (!data) {
    ...
    init(data?: any) {
        super.init(data);
        if (data) {
            this.requestData = data["requestData"] ? CertSettings.fromJS(data["requestData"]) : new CertSettings();
        }
    }
...
export interface IBody2 extends IRequestBase {
    requestData: ICertSettings;
}

export class ConfigFtpPutBody extends RequestBase implements IBody3 {
    requestData!: FtpSettings;

    constructor(data?: IBody3) {
        super(data);
        if (data) {
            this.requestData = data.requestData && !(<any>data.requestData).toJSON ? new FtpSettings(data.requestData) : <FtpSettings>this.requestData;
        }
        if (!data) {
    ...
    init(data?: any) {
        super.init(data);
        if (data) {
            this.requestData = data["requestData"] ? FtpSettings.fromJS(data["requestData"]) : new FtpSettings();
        }
    }
...
export interface IBody3 extends IRequestBase {
    requestData: IFtpSettings;
}

export class ConfigFtpPostBody extends RequestBase implements IBody4 {
    requestData!: FtpSettings;
...
export interface IBody4 extends IRequestBase {
    requestData: IFtpSettings;
}

export class ConfigKmipPutBody extends RequestBase implements IBody5 {
    requestData?: KMIPSettings;

    constructor(data?: IBody5) {
        super(data);
        if (data) {
            this.requestData = data.requestData && !(<any>data.requestData).toJSON ? new KMIPSettings(data.requestData) : <KMIPSettings>this.requestData;
        }
    }
    ...
    init(data?: any) {
        super.init(data);
        if (data) {
            this.requestData = data["requestData"] ? KMIPSettings.fromJS(data["requestData"]) : <any>undefined;
        }
    }
...
export interface IBody5 extends IRequestBase {
    requestData?: IKMIPSettings;
}

export class ConfigLdapPutBody extends RequestBase implements IBody6 {
    requestData!: LDAPConfig;

    constructor(data?: IBody6) {
        super(data);
        if (data) {
            this.requestData = data.requestData && !(<any>data.requestData).toJSON ? new LDAPConfig(data.requestData) : <LDAPConfig>this.requestData;
        }
        if (!data) {
    ...
    init(data?: any) {
        super.init(data);
        if (data) {
            this.requestData = data["requestData"] ? LDAPConfig.fromJS(data["requestData"]) : new LDAPConfig();
        }
    }
...
export interface IBody6 extends IRequestBase {
    requestData: ILDAPConfig;
}

export class ConfigLdapPostBody extends RequestBase implements IBody7 {
    requestData!: LDAPTest;

    constructor(data?: IBody7) {
        super(data);
        if (data) {
            this.requestData = data.requestData && !(<any>data.requestData).toJSON ? new LDAPTest(data.requestData) : <LDAPTest>this.requestData;
        }
        if (!data) {
    ...
    init(data?: any) {
        super.init(data);
        if (data) {
            this.requestData = data["requestData"] ? LDAPTest.fromJS(data["requestData"]) : new LDAPTest();
        }
    }
...
export interface IBody7 extends IRequestBase {
    requestData: ILDAPTest;
}

export class ConfigNetworkPutBody extends RequestBase implements IBody8 {
    requestData?: NetworkSettings;

    constructor(data?: IBody8) {
        super(data);
        if (data) {
            this.requestData = data.requestData && !(<any>data.requestData).toJSON ? new NetworkSettings(data.requestData) : <NetworkSettings>this.requestData;
        }
    }
    ...
    init(data?: any) {
        super.init(data);
        if (data) {
            this.requestData = data["requestData"] ? NetworkSettings.fromJS(data["requestData"]) : <any>undefined;
        }
    }
...
export interface IBody8 extends IRequestBase {
    requestData?: INetworkSettings;
}

export class ConfigNetworkPostBody extends RequestBase implements IBody9 {
    requestData?: Ping;

    constructor(data?: IBody9) {
        super(data);
        if (data) {
            this.requestData = data.requestData && !(<any>data.requestData).toJSON ? new Ping(data.requestData) : <Ping>this.requestData;
        }
    }
    ...
    init(data?: any) {
        super.init(data);
        if (data) {
            this.requestData = data["requestData"] ? Ping.fromJS(data["requestData"]) : <any>undefined;
        }
    }
...
export interface IBody9 extends IRequestBase {
    requestData?: IPing;
}

export class ConfigNtpPutBody extends RequestBase implements IBody10 {
    requestData!: NtpSettings;

    constructor(data?: IBody10) {
        super(data);
        if (data) {
            this.requestData = data.requestData && !(<any>data.requestData).toJSON ? new NtpSettings(data.requestData) : <NtpSettings>this.requestData;
        }
        if (!data) {
    ...
    init(data?: any) {
        super.init(data);
        if (data) {
            this.requestData = data["requestData"] ? NtpSettings.fromJS(data["requestData"]) : new NtpSettings();
        }
    }
...
export interface IBody10 extends IRequestBase {
    requestData: INtpSettings;
}

export class ConfigOcspPutBody extends RequestBase implements IBody11 {
    requestData!: OcspSettings;

    constructor(data?: IBody11) {
        super(data);
        if (data) {
            this.requestData = data.requestData && !(<any>data.requestData).toJSON ? new OcspSettings(data.requestData) : <OcspSettings>this.requestData;
        }
        if (!data) {
    ...
    init(data?: any) {
        super.init(data);
        if (data) {
            this.requestData = data["requestData"] ? OcspSettings.fromJS(data["requestData"]) : new OcspSettings();
        }
    }
...
export interface IBody11 extends IRequestBase {
    requestData: IOcspSettings;
}

export class ConfigPasswordsPutBody extends RequestBase implements IBody12 {
    requestData!: Passwords;

    constructor(data?: IBody12) {
        super(data);
        if (data) {
            this.requestData = data.requestData && !(<any>data.requestData).toJSON ? new Passwords(data.requestData) : <Passwords>this.requestData;
        }
        if (!data) {
    ...
    init(data?: any) {
        super.init(data);
        if (data) {
            this.requestData = data["requestData"] ? Passwords.fromJS(data["requestData"]) : new Passwords();
        }
    }
...
export interface IBody12 extends IRequestBase {
    requestData: IPasswords;
}

export class ConfigPermissionsPutBody extends RequestBase implements IBody13 {
    requestData!: SetPermissions;

    constructor(data?: IBody13) {
        super(data);
        if (data) {
            this.requestData = data.requestData && !(<any>data.requestData).toJSON ? new SetPermissions(data.requestData) : <SetPermissions>this.requestData;
        }
        if (!data) {
    ...
    init(data?: any) {
        super.init(data);
        if (data) {
            this.requestData = data["requestData"] ? SetPermissions.fromJS(data["requestData"]) : new SetPermissions();
        }
    }
...
export interface IBody13 extends IRequestBase {
    requestData: ISetPermissions;
}

export class ConfigRegauthPutBody extends RequestBase implements IBody14 {
    requestData!: RegauthSettings;

    constructor(data?: IBody14) {
        super(data);
        if (data) {
            this.requestData = data.requestData && !(<any>data.requestData).toJSON ? new RegauthSettings(data.requestData) : <RegauthSettings>this.requestData;
        }
        if (!data) {
    ...
    init(data?: any) {
        super.init(data);
        if (data) {
            this.requestData = data["requestData"] ? RegauthSettings.fromJS(data["requestData"]) : new RegauthSettings();
        }
    }
...
export interface IBody14 extends IRequestBase {
    requestData: IRegauthSettings;
}

export class ConfigSmtpPutBody extends RequestBase implements IBody15 {
    requestData!: SmtpSettings;

    constructor(data?: IBody15) {
        super(data);
        if (data) {
            this.requestData = data.requestData && !(<any>data.requestData).toJSON ? new SmtpSettings(data.requestData) : <SmtpSettings>this.requestData;
        }
        if (!data) {
    ...
    init(data?: any) {
        super.init(data);
        if (data) {
            this.requestData = data["requestData"] ? SmtpSettings.fromJS(data["requestData"]) : new SmtpSettings();
        }
    }
...
export interface IBody15 extends IRequestBase {
    requestData: ISmtpSettings;
}

export class ConfigSmtpPostBody extends RequestBase implements IBody16 {
    requestData!: RequestData6;

    constructor(data?: IBody16) {
        super(data);
        if (data) {
            this.requestData = data.requestData && !(<any>data.requestData).toJSON ? new RequestData6(data.requestData) : <RequestData6>this.requestData;
        }
    }
...
export interface IBody16 extends IRequestBase {
    requestData: IRequestData6;
}

export class EmailnotificationsPostBody extends RequestBase implements IBody17 {
    requestData?: SmtpEvent;

    constructor(data?: IBody17) {
        super(data);
        if (data) {
            this.requestData = data.requestData && !(<any>data.requestData).toJSON ? new SmtpEvent(data.requestData) : <SmtpEvent>this.requestData;
        }
    }
    ...
    init(data?: any) {
        super.init(data);
        if (data) {
            this.requestData = data["requestData"] ? SmtpEvent.fromJS(data["requestData"]) : <any>undefined;
        }
    }
...
export interface IBody17 extends IRequestBase {
    requestData?: ISmtpEvent;
}

export class EmailnotificationsPutBody extends RequestBase implements IBody18 {
    requestData?: SmtpEvent;
...
export interface IBody18 extends IRequestBase {
    requestData?: ISmtpEvent;
}

export class FunctionsPutBody extends RequestBase implements IBody19 {
    requestData?: FunctionList;

    constructor(data?: IBody19) {
        super(data);
        if (data) {
            this.requestData = data.requestData && !(<any>data.requestData).toJSON ? new FunctionList(data.requestData) : <FunctionList>this.requestData;
        }
    }
    ...
    init(data?: any) {
        super.init(data);
        if (data) {
            this.requestData = data["requestData"] ? FunctionList.fromJS(data["requestData"]) : <any>undefined;
        }
    }
...
export interface IBody19 extends IRequestBase {
...
export class LogsMiscPutBody extends RequestBase implements IBody20 {
    requestData?: MiscConfig;

    constructor(data?: IBody20) {
        super(data);
        if (data) {
            this.requestData = data.requestData && !(<any>data.requestData).toJSON ? new MiscConfig(data.requestData) : <MiscConfig>this.requestData;
        }
    }
    ...
    init(data?: any) {
        super.init(data);
        if (data) {
            this.requestData = data["requestData"] ? MiscConfig.fromJS(data["requestData"]) : <any>undefined;
        }
    }
...
export interface IBody20 extends IRequestBase {
    requestData?: IMiscConfig;
}

export class LogsPrunePutBody extends RequestBase implements IBody21 {
    requestData?: PruneConfig;

    constructor(data?: IBody21) {
        super(data);
        if (data) {
            this.requestData = data.requestData && !(<any>data.requestData).toJSON ? new PruneConfig(data.requestData) : <PruneConfig>this.requestData;
        }
    }
    ...
    init(data?: any) {
        super.init(data);
        if (data) {
            this.requestData = data["requestData"] ? PruneConfig.fromJS(data["requestData"]) : <any>undefined;
        }
    }
...
export interface IBody21 extends IRequestBase {
    requestData?: IPruneConfig;
}

export class LogsSyslogPutBody extends RequestBase implements IBody22 {
    requestData?: SyslogConfig;

    constructor(data?: IBody22) {
        super(data);
        if (data) {
            this.requestData = data.requestData && !(<any>data.requestData).toJSON ? new SyslogConfig(data.requestData) : <SyslogConfig>this.requestData;
        }
    }
    ...
    init(data?: any) {
        super.init(data);
        if (data) {
            this.requestData = data["requestData"] ? SyslogConfig.fromJS(data["requestData"]) : <any>undefined;
        }
    }
...
export interface IBody22 extends IRequestBase {
    requestData?: ISyslogConfig;
}

export class LogsAuditPutBody extends RequestBase implements IBody23 {
    requestData?: AuditConfig;

    constructor(data?: IBody23) {
        super(data);
        if (data) {
            this.requestData = data.requestData && !(<any>data.requestData).toJSON ? new AuditConfig(data.requestData) : <AuditConfig>this.requestData;
        }
    }
    ...
    init(data?: any) {
        super.init(data);
        if (data) {
            this.requestData = data["requestData"] ? AuditConfig.fromJS(data["requestData"]) : <any>undefined;
        }
    }
...
export interface IBody23 extends IRequestBase {
    requestData?: IAuditConfig;
}

export class PrintersPostBody extends RequestBase implements IBody24 {
    requestData!: RequestData7;

    constructor(data?: IBody24) {
        super(data);
        if (data) {
            this.requestData = data.requestData && !(<any>data.requestData).toJSON ? new RequestData7(data.requestData) : <RequestData7>this.requestData;
        }
    }
...
export interface IBody24 extends IRequestBase {
    requestData: IRequestData7;
}

export class PrintersPutBody extends RequestBase implements IBody25 {
    requestData!: RequestData8;

    constructor(data?: IBody25) {
        super(data);
        if (data) {
            this.requestData = data.requestData && !(<any>data.requestData).toJSON ? new RequestData8(data.requestData) : <RequestData8>this.requestData;
        }
    }
...
export interface IBody25 extends IRequestBase {
    requestData: IRequestData8;
}

export class SecuritymodesFipsPutBody extends RequestBase implements IBody26 {
    requestData?: StatusObject;

    constructor(data?: IBody26) {
        super(data);
        if (data) {
            this.requestData = data.requestData && !(<any>data.requestData).toJSON ? new StatusObject(data.requestData) : <StatusObject>this.requestData;
        }
    }
    ...
    init(data?: any) {
        super.init(data);
        if (data) {
            this.requestData = data["requestData"] ? StatusObject.fromJS(data["requestData"]) : <any>undefined;
        }
    }
...
export interface IBody26 extends IRequestBase {
    requestData?: IStatusObject;
}

export class SecuritymodesPciPutBody extends RequestBase implements IBody27 {
    requestData?: StatusObject;
...
export interface IBody27 extends IRequestBase {
    requestData?: IStatusObject;
}

export class SftpeventsPostBody extends RequestBase implements IBody28 {
    requestData!: SftpEvent;

    constructor(data?: IBody28) {
        super(data);
        if (data) {
            this.requestData = data.requestData && !(<any>data.requestData).toJSON ? new SftpEvent(data.requestData) : <SftpEvent>this.requestData;
        }
        if (!data) {
    ...
    init(data?: any) {
        super.init(data);
        if (data) {
            this.requestData = data["requestData"] ? SftpEvent.fromJS(data["requestData"]) : new SftpEvent();
        }
    }
...
export interface IBody28 extends IRequestBase {
    requestData: ISftpEvent;
}

export class SftpeventsPutBody extends RequestBase implements IBody29 {
    requestData?: SftpEvent;
    ...
    init(data?: any) {
        super.init(data);
        if (data) {
            this.requestData = data["requestData"] ? SftpEvent.fromJS(data["requestData"]) : <any>undefined;
        }
    }
...
export interface IBody29 extends IRequestBase {
    requestData?: ISftpEvent;
}

export class SystemDatetimePutBody extends RequestBase implements IBody30 {
    requestData?: SystemDateTime;

    constructor(data?: IBody30) {
        super(data);
        if (data) {
            this.requestData = data.requestData && !(<any>data.requestData).toJSON ? new SystemDateTime(data.requestData) : <SystemDateTime>this.requestData;
        }
    }
    ...
    init(data?: any) {
        super.init(data);
        if (data) {
            this.requestData = data["requestData"] ? SystemDateTime.fromJS(data["requestData"]) : <any>undefined;
        }
    }
...
export interface IBody30 extends IRequestBase {
    requestData?: ISystemDateTime;
}

export class SystemDatabaseBackupPostBody extends RequestBase implements IBody31 {
    requestData?: DBBackup;

    constructor(data?: IBody31) {
        super(data);
        if (data) {
            this.requestData = data.requestData && !(<any>data.requestData).toJSON ? new DBBackup(data.requestData) : <DBBackup>this.requestData;
        }
    }
    ...
    init(data?: any) {
        super.init(data);
        if (data) {
            this.requestData = data["requestData"] ? DBBackup.fromJS(data["requestData"]) : <any>undefined;
        }
    }
...
export interface IBody31 extends IRequestBase {
    requestData?: IDBBackup;
}

export class SystemDatabaseBackupPutBody extends RequestBase implements IBody32 {
    requestData?: DBBackupRestore;

    constructor(data?: IBody32) {
        super(data);
        if (data) {
            this.requestData = data.requestData && !(<any>data.requestData).toJSON ? new DBBackupRestore(data.requestData) : <DBBackupRestore>this.requestData;
        }
    }
    ...
    init(data?: any) {
        super.init(data);
        if (data) {
            this.requestData = data["requestData"] ? DBBackupRestore.fromJS(data["requestData"]) : <any>undefined;
        }
    }
...
export interface IBody32 extends IRequestBase {
    requestData?: IDBBackupRestore;
}

export class SystemDiskPutBody extends RequestBase implements IBody33 {
    requestData?: DiskRaidStatus;

    constructor(data?: IBody33) {
        super(data);
        if (data) {
            this.requestData = data.requestData && !(<any>data.requestData).toJSON ? new DiskRaidStatus(data.requestData) : <DiskRaidStatus>this.requestData;
        }
    }
    ...
    init(data?: any) {
        super.init(data);
        if (data) {
            this.requestData = data["requestData"] ? DiskRaidStatus.fromJS(data["requestData"]) : <any>undefined;
        }
    }
...
export interface IBody33 extends IRequestBase {
    requestData?: IDiskRaidStatus;
}

export class TemplatesPostBody extends RequestBase implements IBody34 {
    requestData!: Template;

    constructor(data?: IBody34) {
        super(data);
        if (data) {
            this.requestData = data.requestData && !(<any>data.requestData).toJSON ? new Template(data.requestData) : <Template>this.requestData;
        }
        if (!data) {
    ...
    init(data?: any) {
        super.init(data);
        if (data) {
            this.requestData = data["requestData"] ? Template.fromJS(data["requestData"]) : new Template();
        }
    }
...
export interface IBody34 extends IRequestBase {
...
export class TemplatesPutBody extends RequestBase implements IBody35 {
    requestData!: UpdateTemplate;

    constructor(data?: IBody35) {
        super(data);
        if (data) {
            this.requestData = data.requestData && !(<any>data.requestData).toJSON ? new UpdateTemplate(data.requestData) : <UpdateTemplate>this.requestData;
        }
        if (!data) {
    ...
    init(data?: any) {
        super.init(data);
        if (data) {
            this.requestData = data["requestData"] ? UpdateTemplate.fromJS(data["requestData"]) : new UpdateTemplate();
        }
    }
...
export interface IBody35 extends IRequestBase {
    requestData: IUpdateTemplate;
}

export class UsergroupsPostBody extends RequestBase implements IBody36 {
    requestData?: UserGroup;

    constructor(data?: IBody36) {
        super(data);
        if (data) {
            this.requestData = data.requestData && !(<any>data.requestData).toJSON ? new UserGroup(data.requestData) : <UserGroup>this.requestData;
        }
    }
    ...
    init(data?: any) {
        super.init(data);
        if (data) {
            this.requestData = data["requestData"] ? UserGroup.fromJS(data["requestData"]) : <any>undefined;
        }
    }
...
export interface IBody36 extends IRequestBase {
    requestData?: IUserGroup;
}

export class UsersPostBody extends RequestBase implements IUsersPostBodyData {
    requestData?: UsersPostBodyRequestData;

    constructor(data?: IUsersPostBodyData) {
        super(data);
        if (data) {
            this.requestData = data.requestData && !(<any>data.requestData).toJSON ? new UsersPostBodyRequestData(data.requestData) : <UsersPostBodyRequestData>this.requestData;
        }
    }
...
export interface IUsersPostBodyData extends IRequestBase {
    requestData?: IUsersPostBodyRequestData;
}

export class WebserverPutBody extends RequestBase implements IBody38 {
    requestData?: WebServer;

    constructor(data?: IBody38) {
        super(data);
        if (data) {
            this.requestData = data.requestData && !(<any>data.requestData).toJSON ? new WebServer(data.requestData) : <WebServer>this.requestData;
        }
    }
    ...
    init(data?: any) {
        super.init(data);
        if (data) {
            this.requestData = data["requestData"] ? WebServer.fromJS(data["requestData"]) : <any>undefined;
        }
    }
...
export interface IBody38 extends IRequestBase {
    requestData?: IWebServer;
}

export class ConfigAutoBackupGetResponse extends ResponseBase implements IAnonymous {
    responseData?: AutoBackup;

    constructor(data?: IAnonymous) {
        super(data);
        if (data) {
            this.responseData = data.responseData && !(<any>data.responseData).toJSON ? new AutoBackup(data.responseData) : <AutoBackup>this.responseData;
        }
    }
    ...
    init(data?: any) {
        super.init(data);
        if (data) {
            this.responseData = data["responseData"] ? AutoBackup.fromJS(data["responseData"]) : <any>undefined;
        }
    }
...
export interface IAnonymous extends IResponseBase {
    responseData?: IAutoBackup;
}

export class ConfigCertificatesGetResponse extends ResponseBase implements IAnonymous2 {
    responseData?: CertSettings;

    constructor(data?: IAnonymous2) {
        super(data);
        if (data) {
            this.responseData = data.responseData && !(<any>data.responseData).toJSON ? new CertSettings(data.responseData) : <CertSettings>this.responseData;
        }
    }
    ...
    init(data?: any) {
        super.init(data);
        if (data) {
            this.responseData = data["responseData"] ? CertSettings.fromJS(data["responseData"]) : <any>undefined;
        }
    }
...
export interface IAnonymous2 extends IResponseBase {
    responseData?: ICertSettings;
}

export class ConfigFtpGetResponse extends ResponseBase implements IAnonymous3 {
    responseData?: ResponseData;

    constructor(data?: IAnonymous3) {
        super(data);
        if (data) {
            this.responseData = data.responseData && !(<any>data.responseData).toJSON ? new ResponseData(data.responseData) : <ResponseData>this.responseData;
        }
    }
...
export interface IAnonymous3 extends IResponseBase {
    responseData?: IResponseData;
}

export class ConfigKmipGetResponse extends ResponseBase implements IAnonymous4 {
    responseData?: KMIPSettings;

    constructor(data?: IAnonymous4) {
        super(data);
        if (data) {
            this.responseData = data.responseData && !(<any>data.responseData).toJSON ? new KMIPSettings(data.responseData) : <KMIPSettings>this.responseData;
        }
    }
    ...
    init(data?: any) {
        super.init(data);
        if (data) {
            this.responseData = data["responseData"] ? KMIPSettings.fromJS(data["responseData"]) : <any>undefined;
        }
    }
...
export interface IAnonymous4 extends IResponseBase {
    responseData?: IKMIPSettings;
}

export class ConfigLdapGetResponse extends ResponseBase implements IAnonymous5 {
    responseData?: LDAPConfig;

    constructor(data?: IAnonymous5) {
        super(data);
        if (data) {
            this.responseData = data.responseData && !(<any>data.responseData).toJSON ? new LDAPConfig(data.responseData) : <LDAPConfig>this.responseData;
        }
    }
    ...
    init(data?: any) {
        super.init(data);
        if (data) {
            this.responseData = data["responseData"] ? LDAPConfig.fromJS(data["responseData"]) : <any>undefined;
        }
    }
...
export interface IAnonymous5 extends IResponseBase {
    responseData?: ILDAPConfig;
}

export class ConfigNetworkGetResponse extends ResponseBase implements IAnonymous6 {
    responseData?: NetworkSettings;

    constructor(data?: IAnonymous6) {
        super(data);
        if (data) {
            this.responseData = data.responseData && !(<any>data.responseData).toJSON ? new NetworkSettings(data.responseData) : <NetworkSettings>this.responseData;
        }
    }
    ...
    init(data?: any) {
        super.init(data);
        if (data) {
            this.responseData = data["responseData"] ? NetworkSettings.fromJS(data["responseData"]) : <any>undefined;
        }
    }
...
export interface IAnonymous6 extends IResponseBase {
    responseData?: INetworkSettings;
}

export class ConfigNetworkPostResponse extends ResponseBase implements IAnonymous7 {
    responseData?: ResponseData2;

    constructor(data?: IAnonymous7) {
        super(data);
        if (data) {
            this.responseData = data.responseData && !(<any>data.responseData).toJSON ? new ResponseData2(data.responseData) : <ResponseData2>this.responseData;
        }
    }
    ...
    init(data?: any) {
        super.init(data);
        if (data) {
            this.responseData = data["responseData"] ? ResponseData2.fromJS(data["responseData"]) : <any>undefined;
        }
    }
...
export interface IAnonymous7 extends IResponseBase {
    responseData?: IResponseData2;
}

export class ConfigNtpGetResponse extends ResponseBase implements IAnonymous8 {
    responseData?: NtpSettings;

    constructor(data?: IAnonymous8) {
        super(data);
        if (data) {
            this.responseData = data.responseData && !(<any>data.responseData).toJSON ? new NtpSettings(data.responseData) : <NtpSettings>this.responseData;
        }
    }
    ...
    init(data?: any) {
        super.init(data);
        if (data) {
            this.responseData = data["responseData"] ? NtpSettings.fromJS(data["responseData"]) : <any>undefined;
        }
    }
...
export interface IAnonymous8 extends IResponseBase {
    responseData?: INtpSettings;
}

export class ConfigOcspGetResponse extends ResponseBase implements IAnonymous9 {
    responseData?: OcspSettings;

    constructor(data?: IAnonymous9) {
        super(data);
        if (data) {
            this.responseData = data.responseData && !(<any>data.responseData).toJSON ? new OcspSettings(data.responseData) : <OcspSettings>this.responseData;
        }
    }
    ...
    init(data?: any) {
        super.init(data);
        if (data) {
            this.responseData = data["responseData"] ? OcspSettings.fromJS(data["responseData"]) : <any>undefined;
        }
    }
...
export interface IAnonymous9 extends IResponseBase {
    responseData?: IOcspSettings;
}

export class ConfigPasswordsGetResponse extends ResponseBase implements IAnonymous10 {
    responseData?: Passwords;

    constructor(data?: IAnonymous10) {
        super(data);
        if (data) {
            this.responseData = data.responseData && !(<any>data.responseData).toJSON ? new Passwords(data.responseData) : <Passwords>this.responseData;
        }
    }
    ...
    init(data?: any) {
        super.init(data);
        if (data) {
            this.responseData = data["responseData"] ? Passwords.fromJS(data["responseData"]) : <any>undefined;
        }
    }
...
export interface IAnonymous10 extends IResponseBase {
    responseData?: IPasswords;
}

export class ConfigPermissionsGetResponse extends ResponseBase implements IAnonymous11 {
    responseData?: GetPermissions;

    constructor(data?: IAnonymous11) {
        super(data);
        if (data) {
            this.responseData = data.responseData && !(<any>data.responseData).toJSON ? new GetPermissions(data.responseData) : <GetPermissions>this.responseData;
        }
    }
    ...
    init(data?: any) {
        super.init(data);
        if (data) {
            this.responseData = data["responseData"] ? GetPermissions.fromJS(data["responseData"]) : <any>undefined;
        }
    }
...
export interface IAnonymous11 extends IResponseBase {
    responseData?: IGetPermissions;
}

export class ConfigRegauthGetResponse extends ResponseBase implements IAnonymous12 {
    responseData?: RegauthSettings;

    constructor(data?: IAnonymous12) {
        super(data);
        if (data) {
            this.responseData = data.responseData && !(<any>data.responseData).toJSON ? new RegauthSettings(data.responseData) : <RegauthSettings>this.responseData;
        }
    }
    ...
    init(data?: any) {
        super.init(data);
        if (data) {
            this.responseData = data["responseData"] ? RegauthSettings.fromJS(data["responseData"]) : <any>undefined;
        }
    }
...
export interface IAnonymous12 extends IResponseBase {
    responseData?: IRegauthSettings;
}

export class ConfigSmtpGetResponse extends ResponseBase implements IAnonymous13 {
    responseData?: SmtpSettings;

    constructor(data?: IAnonymous13) {
        super(data);
        if (data) {
            this.responseData = data.responseData && !(<any>data.responseData).toJSON ? new SmtpSettings(data.responseData) : <SmtpSettings>this.responseData;
        }
    }
    ...
    init(data?: any) {
        super.init(data);
        if (data) {
            this.responseData = data["responseData"] ? SmtpSettings.fromJS(data["responseData"]) : <any>undefined;
        }
    }
...
export interface IAnonymous13 extends IResponseBase {
    responseData?: ISmtpSettings;
}

export class DuplicateObjectsGetResponse extends ResponseBase implements IAnonymous14 {
    responseData?: ListObjectTypes;

    constructor(data?: IAnonymous14) {
        super(data);
        if (data) {
            this.responseData = data.responseData && !(<any>data.responseData).toJSON ? new ListObjectTypes(data.responseData) : <ListObjectTypes>this.responseData;
        }
    }
    ...
    init(data?: any) {
        super.init(data);
        if (data) {
            this.responseData = data["responseData"] ? ListObjectTypes.fromJS(data["responseData"]) : <any>undefined;
        }
    }
...
export interface IAnonymous14 extends IResponseBase {
    responseData?: IListObjectTypes;
}

export class EmailnotificationsGetResponse extends ResponseBase implements IAnonymous15 {
    responseData!: EmailList;

    constructor(data?: IAnonymous15) {
        super(data);
        if (data) {
            this.responseData = data.responseData && !(<any>data.responseData).toJSON ? new EmailList(data.responseData) : <EmailList>this.responseData;
        }
        if (!data) {
    ...
    init(data?: any) {
        super.init(data);
        if (data) {
            this.responseData = data["responseData"] ? EmailList.fromJS(data["responseData"]) : new EmailList();
        }
    }
...
export interface IAnonymous15 extends IResponseBase {
    responseData: IEmailList;
}

export class FeaturesResponse extends ResponseBase implements IAnonymous16 {
    responseData?: FeatureList;

    constructor(data?: IAnonymous16) {
        super(data);
        if (data) {
            this.responseData = data.responseData && !(<any>data.responseData).toJSON ? new FeatureList(data.responseData) : <FeatureList>this.responseData;
        }
    }
    ...
    init(data?: any) {
        super.init(data);
        if (data) {
            this.responseData = data["responseData"] ? FeatureList.fromJS(data["responseData"]) : <any>undefined;
        }
    }
...
export interface IAnonymous16 extends IResponseBase {
    responseData?: IFeatureList;
}

export class FeaturesRequestGetResponse extends ResponseBase implements IAnonymous17 {
    responseData?: FeatureRequest;

    constructor(data?: IAnonymous17) {
        super(data);
        if (data) {
            this.responseData = data.responseData && !(<any>data.responseData).toJSON ? new FeatureRequest(data.responseData) : <FeatureRequest>this.responseData;
        }
    }
    ...
    init(data?: any) {
        super.init(data);
        if (data) {
            this.responseData = data["responseData"] ? FeatureRequest.fromJS(data["responseData"]) : <any>undefined;
        }
    }
...
export interface IAnonymous17 extends IResponseBase {
    responseData?: IFeatureRequest;
}

export class FeaturesRequestPutResponse extends ResponseBase implements IAnonymous18 {
    responseData?: ResponseData3;

    constructor(data?: IAnonymous18) {
        super(data);
        if (data) {
            this.responseData = data.responseData && !(<any>data.responseData).toJSON ? new ResponseData3(data.responseData) : <ResponseData3>this.responseData;
        }
    }
    ...
    init(data?: any) {
        super.init(data);
        if (data) {
            this.responseData = data["responseData"] ? ResponseData3.fromJS(data["responseData"]) : <any>undefined;
        }
    }
...
export interface IAnonymous18 extends IResponseBase {
    responseData?: IResponseData3;
}

export class FunctionsGetResponse extends ResponseBase implements IAnonymous19 {
    responseData?: FunctionList;

    constructor(data?: IAnonymous19) {
        super(data);
        if (data) {
            this.responseData = data.responseData && !(<any>data.responseData).toJSON ? new FunctionList(data.responseData) : <FunctionList>this.responseData;
        }
    }
    ...
    init(data?: any) {
        super.init(data);
        if (data) {
            this.responseData = data["responseData"] ? FunctionList.fromJS(data["responseData"]) : <any>undefined;
        }
    }
...
export interface IAnonymous19 extends IResponseBase {
    responseData?: IFunctionList;
}

export class FxcertcrlsGetResponse extends ResponseBase implements IAnonymous20 {
    responseData?: CrlDetails;

    constructor(data?: IAnonymous20) {
        super(data);
        if (data) {
            this.responseData = data.responseData && !(<any>data.responseData).toJSON ? new CrlDetails(data.responseData) : <CrlDetails>this.responseData;
        }
    }
    ...
    init(data?: any) {
        super.init(data);
        if (data) {
            this.responseData = data["responseData"] ? CrlDetails.fromJS(data["responseData"]) : <any>undefined;
        }
    }
...
export interface IAnonymous20 extends IResponseBase {
    responseData?: ICrlDetails;
}

export class JobsResponse extends ResponseBase implements IAnonymous21 {
    jobCount?: number;
    jobs?: Job[];
        ...
        if (data) {
            if (data.jobs) {
                ...
                for (let i = 0; i < data.jobs.length; i++) {
                    ...
                    this.jobs[i] = item && !(<any>item).toJSON ? new Job(item) : <Job>item;
                }
            }
        }
    }
...
export interface IAnonymous21 extends IResponseBase {
    jobCount?: number;
    jobs?: IJob[];
}

export class LoginResponse extends ResponseBase implements IAnonymous22 {
    responseData?: ResponseData4;

    constructor(data?: IAnonymous22) {
        super(data);
        if (data) {
            this.responseData = data.responseData && !(<any>data.responseData).toJSON ? new ResponseData4(data.responseData) : <ResponseData4>this.responseData;
        }
    }
...
export interface IAnonymous22 extends IResponseBase {
    responseData?: IResponseData4;
}

export class LogsResponse extends ResponseBase implements IAnonymous23 {
    responseData?: LogFileList;

    constructor(data?: IAnonymous23) {
        super(data);
        if (data) {
            this.responseData = data.responseData && !(<any>data.responseData).toJSON ? new LogFileList(data.responseData) : <LogFileList>this.responseData;
        }
    }
    ...
    init(data?: any) {
        super.init(data);
        if (data) {
            this.responseData = data["responseData"] ? LogFileList.fromJS(data["responseData"]) : <any>undefined;
        }
    }
...
export interface IAnonymous23 extends IResponseBase {
    responseData?: ILogFileList;
}

export class LogsMiscGetResponse extends ResponseBase implements IAnonymous24 {
    responseData?: MiscConfig;

    constructor(data?: IAnonymous24) {
        super(data);
        if (data) {
            this.responseData = data.responseData && !(<any>data.responseData).toJSON ? new MiscConfig(data.responseData) : <MiscConfig>this.responseData;
        }
    }
    ...
    init(data?: any) {
        super.init(data);
        if (data) {
            this.responseData = data["responseData"] ? MiscConfig.fromJS(data["responseData"]) : <any>undefined;
        }
    }
...
export interface IAnonymous24 extends IResponseBase {
    responseData?: IMiscConfig;
}

export class LogsPruneGetResponse extends ResponseBase implements IAnonymous25 {
    responseData?: PruneConfig;

    constructor(data?: IAnonymous25) {
        super(data);
        if (data) {
            this.responseData = data.responseData && !(<any>data.responseData).toJSON ? new PruneConfig(data.responseData) : <PruneConfig>this.responseData;
        }
    }
    ...
    init(data?: any) {
        super.init(data);
        if (data) {
            this.responseData = data["responseData"] ? PruneConfig.fromJS(data["responseData"]) : <any>undefined;
        }
    }
...
export interface IAnonymous25 extends IResponseBase {
    responseData?: IPruneConfig;
}

export class LogsSyslogGetResponse extends ResponseBase implements IAnonymous26 {
    responseData?: SyslogConfig;

    constructor(data?: IAnonymous26) {
        super(data);
        if (data) {
            this.responseData = data.responseData && !(<any>data.responseData).toJSON ? new SyslogConfig(data.responseData) : <SyslogConfig>this.responseData;
        }
    }
    ...
    init(data?: any) {
        super.init(data);
        if (data) {
            this.responseData = data["responseData"] ? SyslogConfig.fromJS(data["responseData"]) : <any>undefined;
        }
    }
...
export interface IAnonymous26 extends IResponseBase {
    responseData?: ISyslogConfig;
}

export class LogsAuditGetResponse extends ResponseBase implements IAnonymous27 {
    responseData?: AuditConfig;

    constructor(data?: IAnonymous27) {
        super(data);
        if (data) {
            this.responseData = data.responseData && !(<any>data.responseData).toJSON ? new AuditConfig(data.responseData) : <AuditConfig>this.responseData;
        }
    }
    ...
    init(data?: any) {
        super.init(data);
        if (data) {
            this.responseData = data["responseData"] ? AuditConfig.fromJS(data["responseData"]) : <any>undefined;
        }
    }
...
export interface IAnonymous27 extends IResponseBase {
    responseData?: IAuditConfig;
}

export class PrintersGetResponse extends ResponseBase implements IAnonymous28 {
    responseData?: PrinterList;

    constructor(data?: IAnonymous28) {
        super(data);
        if (data) {
            this.responseData = data.responseData && !(<any>data.responseData).toJSON ? new PrinterList(data.responseData) : <PrinterList>this.responseData;
        }
    }
    ...
    init(data?: any) {
        super.init(data);
        if (data) {
            this.responseData = data["responseData"] ? PrinterList.fromJS(data["responseData"]) : <any>undefined;
        }
    }
...
export interface IAnonymous28 extends IResponseBase {
    responseData?: IPrinterList;
}

export class SecuritymodesFipsGetResponse extends ResponseBase implements IAnonymous29 {
    responseData?: StatusObject;

    constructor(data?: IAnonymous29) {
        super(data);
        if (data) {
            this.responseData = data.responseData && !(<any>data.responseData).toJSON ? new StatusObject(data.responseData) : <StatusObject>this.responseData;
        }
    }
    ...
    init(data?: any) {
        super.init(data);
        if (data) {
            this.responseData = data["responseData"] ? StatusObject.fromJS(data["responseData"]) : <any>undefined;
        }
    }
...
export interface IAnonymous29 extends IResponseBase {
    responseData?: IStatusObject;
}

export class SecuritymodesPciGetResponse extends ResponseBase implements IAnonymous30 {
    responseData?: StatusObject;
...
export interface IAnonymous30 extends IResponseBase {
    responseData?: IStatusObject;
}

export class SftpEventsGetResponse extends ResponseBase implements IAnonymous31 {
    responseData?: SftpList;

    constructor(data?: IAnonymous31) {
        super(data);
        if (data) {
            this.responseData = data.responseData && !(<any>data.responseData).toJSON ? new SftpList(data.responseData) : <SftpList>this.responseData;
        }
    }
    ...
    init(data?: any) {
        super.init(data);
        if (data) {
            this.responseData = data["responseData"] ? SftpList.fromJS(data["responseData"]) : <any>undefined;
        }
    }
...
export interface IAnonymous31 extends IResponseBase {
    responseData?: ISftpList;
}

export class SystemGetResponse extends ResponseBase implements IAnonymous32 {
    responseData?: ServerInfo;

    constructor(data?: IAnonymous32) {
        super(data);
        if (data) {
            this.responseData = data.responseData && !(<any>data.responseData).toJSON ? new ServerInfo(data.responseData) : <ServerInfo>this.responseData;
        }
    }
    ...
    init(data?: any) {
        super.init(data);
        if (data) {
            this.responseData = data["responseData"] ? ServerInfo.fromJS(data["responseData"]) : <any>undefined;
        }
    }
...
export interface IAnonymous32 extends IResponseBase {
    responseData?: IServerInfo;
}

export class SystemDatetimeGetResponse extends ResponseBase implements IAnonymous33 {
    responseData?: ResponseData5;

    constructor(data?: IAnonymous33) {
        super(data);
        if (data) {
            this.responseData = data.responseData && !(<any>data.responseData).toJSON ? new ResponseData5(data.responseData) : <ResponseData5>this.responseData;
        }
    }
...
export interface IAnonymous33 extends IResponseBase {
    responseData?: IResponseData5;
}

export class SystemFirmwareGetResponse extends ResponseBase implements IAnonymous34 {
    responseData?: FirmwareInfo;

    constructor(data?: IAnonymous34) {
        super(data);
        if (data) {
            this.responseData = data.responseData && !(<any>data.responseData).toJSON ? new FirmwareInfo(data.responseData) : <FirmwareInfo>this.responseData;
        }
    }
    ...
    init(data?: any) {
        super.init(data);
        if (data) {
            this.responseData = data["responseData"] ? FirmwareInfo.fromJS(data["responseData"]) : <any>undefined;
        }
    }
...
export interface IAnonymous34 extends IResponseBase {
    responseData?: IFirmwareInfo;
}

export class SystemDatabaseGetResponse extends ResponseBase implements IAnonymous35 {
    responseData?: DBInfo;

    constructor(data?: IAnonymous35) {
        super(data);
        if (data) {
            this.responseData = data.responseData && !(<any>data.responseData).toJSON ? new DBInfo(data.responseData) : <DBInfo>this.responseData;
        }
    }
    ...
    init(data?: any) {
        super.init(data);
        if (data) {
            this.responseData = data["responseData"] ? DBInfo.fromJS(data["responseData"]) : <any>undefined;
        }
    }
...
export interface IAnonymous35 extends IResponseBase {
    responseData?: IDBInfo;
}

export class SystemDatabaseBackupGetResponse extends ResponseBase implements IAnonymous36 {
    responseData?: DBBackupList;

    constructor(data?: IAnonymous36) {
        super(data);
        if (data) {
            this.responseData = data.responseData && !(<any>data.responseData).toJSON ? new DBBackupList(data.responseData) : <DBBackupList>this.responseData;
        }
    }
    ...
    init(data?: any) {
        super.init(data);
        if (data) {
            this.responseData = data["responseData"] ? DBBackupList.fromJS(data["responseData"]) : <any>undefined;
        }
    }
...
export interface IAnonymous36 extends IResponseBase {
    responseData?: IDBBackupList;
}

export class SystemDiskGetResponse extends ResponseBase implements IAnonymous37 {
    responseData?: DiskInfo;

    constructor(data?: IAnonymous37) {
        super(data);
        if (data) {
            this.responseData = data.responseData && !(<any>data.responseData).toJSON ? new DiskInfo(data.responseData) : <DiskInfo>this.responseData;
        }
    }
    ...
    init(data?: any) {
        super.init(data);
        if (data) {
            this.responseData = data["responseData"] ? DiskInfo.fromJS(data["responseData"]) : <any>undefined;
        }
    }
...
export interface IAnonymous37 extends IResponseBase {
    responseData?: IDiskInfo;
}

export class SystemRaidResponse extends ResponseBase implements IAnonymous38 {
    responseData?: RaidList;

    constructor(data?: IAnonymous38) {
        super(data);
        if (data) {
            this.responseData = data.responseData && !(<any>data.responseData).toJSON ? new RaidList(data.responseData) : <RaidList>this.responseData;
        }
    }
    ...
    init(data?: any) {
        super.init(data);
        if (data) {
            this.responseData = data["responseData"] ? RaidList.fromJS(data["responseData"]) : <any>undefined;
        }
    }
...
export interface IAnonymous38 extends IResponseBase {
    responseData?: IRaidList;
}

export class TemplatesGetResponse extends ResponseBase implements IAnonymous39 {
    responseData?: Template;

    constructor(data?: IAnonymous39) {
        super(data);
        if (data) {
            this.responseData = data.responseData && !(<any>data.responseData).toJSON ? new Template(data.responseData) : <Template>this.responseData;
        }
    }
    ...
    init(data?: any) {
        super.init(data);
        if (data) {
            this.responseData = data["responseData"] ? Template.fromJS(data["responseData"]) : <any>undefined;
        }
    }
...
export interface IAnonymous39 extends IResponseBase {
    responseData?: ITemplate;
}

export class UsergroupsGetResponse extends ResponseBase implements IAnonymous40 {
    responseData?: ResponseData6;

    constructor(data?: IAnonymous40) {
        super(data);
        if (data) {
            this.responseData = data.responseData && !(<any>data.responseData).toJSON ? new ResponseData6(data.responseData) : <ResponseData6>this.responseData;
        }
    }
    ...
    init(data?: any) {
        super.init(data);
        if (data) {
            this.responseData = data["responseData"] ? ResponseData6.fromJS(data["responseData"]) : <any>undefined;
        }
    }
...
export interface IAnonymous40 extends IResponseBase {
    responseData?: IResponseData6;
}

export class UsersGetResponse extends ResponseBase implements IAnonymous41 {
    responseData?: GetUserList;

    constructor(data?: IAnonymous41) {
        super(data);
        if (data) {
            this.responseData = data.responseData && !(<any>data.responseData).toJSON ? new GetUserList(data.responseData) : <GetUserList>this.responseData;
        }
    }
    ...
    init(data?: any) {
        super.init(data);
        if (data) {
            this.responseData = data["responseData"] ? GetUserList.fromJS(data["responseData"]) : <any>undefined;
        }
    }
...
export interface IAnonymous41 extends IResponseBase {
    responseData?: IGetUserList;
}

export class WebserverGetResponse extends ResponseBase implements IAnonymous42 {
    responseData?: WebServer;

    constructor(data?: IAnonymous42) {
        super(data);
        if (data) {
            this.responseData = data.responseData && !(<any>data.responseData).toJSON ? new WebServer(data.responseData) : <WebServer>this.responseData;
        }
    }
    ...
    init(data?: any) {
        super.init(data);
        if (data) {
            this.responseData = data["responseData"] ? WebServer.fromJS(data["responseData"]) : <any>undefined;
        }
    }
...
export interface IAnonymous42 extends IResponseBase {
...
export class TimestampFilter implements ITimestampFilter {
    ...
    init(data?: any) {
        if (data) {
            ...
            this.startTime = data["startTime"] !== undefined ? data["startTime"] : "00:00:00";
            this.endTime = data["endTime"] !== undefined ? data["endTime"] : "00:00:00";
            if (Array.isArray(data["dayOfWeek"])) {
                this.dayOfWeek = [] as any;
                for (let item of data["dayOfWeek"])
...
export class Permissions2 implements IPermissions2 {
    ...
    toJSON(data?: any) {
        ...
        if (Array.isArray(this.settingOptions)) {
            data["settingOptions"] = [];
            for (let item of this.settingOptions)
                data["settingOptions"].push(item);
        }
        return data;
    }
}
...
export class Events extends KSNEvents implements IEvents {
    ...
    constructor(data?: IEvents) {
        super(data);
        if (data) {
            this.logExport = data.logExport && !(<any>data.logExport).toJSON ? new LogExportEvents(data.logExport) : <LogExportEvents>this.logExport;
        }
    }
    ...
    init(data?: any) {
        ...
        if (data) {
            this.certAlmostExpired = data["certAlmostExpired"];
            this.certExpired = data["certExpired"];
            this.logExport = data["logExport"] ? LogExportEvents.fromJS(data["logExport"]) : <any>undefined;
        }
    }
    ...
    toJSON(data?: any) {
        ...
        data["certAlmostExpired"] = this.certAlmostExpired;
        data["certExpired"] = this.certExpired;
        data["logExport"] = this.logExport ? this.logExport.toJSON() : <any>undefined;
        super.toJSON(data);
        return data;
    }
}
...
export class Features implements IFeatures {
    ...
    constructor(data?: IFeatures) {
        if (data) {
            ...
            this.application = data.application && !(<any>data.application).toJSON ? new FeatureListItems(data.application) : <FeatureListItems>this.application;
            this.firmware = data.firmware && !(<any>data.firmware).toJSON ? new FeatureListItems(data.firmware) : <FeatureListItems>this.firmware;
            this.virtual = data.virtual && !(<any>data.virtual).toJSON ? new FeatureListItems(data.virtual) : <FeatureListItems>this.virtual;
        }
    }

    init(data?: any) {
        if (data) {
            this.application = data["application"] ? FeatureListItems.fromJS(data["application"]) : <any>undefined;
            this.firmware = data["firmware"] ? FeatureListItems.fromJS(data["firmware"]) : <any>undefined;
            this.virtual = data["virtual"] ? FeatureListItems.fromJS(data["virtual"]) : <any>undefined;
        }
    }
...
export class Events2 implements IEvents2 {
    ...
    constructor(data?: IEvents2) {
        if (data) {
            ...
            this.keyExport = data.keyExport && !(<any>data.keyExport).toJSON ? new KeyExport(data.keyExport) : <KeyExport>this.keyExport;
        }
    }

    init(data?: any) {
        if (data) {
            this.keyExport = data["keyExport"] ? KeyExport.fromJS(data["keyExport"]) : <any>undefined;
        }
    }
    ...
    toJSON(data?: any) {
        data = typeof data === 'object' ? data : {};
        data["keyExport"] = this.keyExport ? this.keyExport.toJSON() : <any>undefined;
        return data;
    }
}
...
export class UsersPostBodyRequestData extends CreateUser implements IUsersPostBodyRequestData {
    newPassword?: string;
...
export class ResponseData5 extends SystemDateTime implements IResponseData5 {
    ...
    toJSON(data?: any) {
        ...
        if (Array.isArray(this.availableZones)) {
            data["availableZones"] = [];
            for (let item of this.availableZones)
                data["availableZones"].push(item);
        }
        super.toJSON(data);
        return data;
    }
